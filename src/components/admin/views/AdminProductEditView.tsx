...
const AdminProductEditView = () => {
    ...
    // Safely handle params which can be undefined or array in some contexts
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        // Remove the derived 'image' field before saving, as it's computed
...
export default AdminProductEditView;
